...
FLOW_SET = '5H.5H.LD5_CK2222_FlowSet'  # '流量设定值'
BATCH = '6032.6032.LD5_YT603_2B_YS2ROASTBATCHNO'  # '批次'
#为了验证物料机满导致水分下降问题，需要提前触发计算，使用切丝批开始作为触发
BRADN = '6032.6032.LC5_YT603_2A_YS2CUTBRAND'
BRADN_DRYING = '6032.6032.LD5_YT603_2B_YS2ROASTBRAND'  # '牌号'
